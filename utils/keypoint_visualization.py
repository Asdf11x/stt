"""keypoint_visualization.py: Create visualizations of keypoint estimation by OpenPose"""
...
class JSONVis:
    ...
    def draw_main(self, path_to_json_dir):
        ...
        for subdir in subdirectories:
            self.json_files = [pos_json for pos_json in os.listdir(data_dir_origin / subdir) if
    ...
    def draw(self):
        ...
        video = cv2.VideoWriter(str(self.path_to_output / 'json_vis.avi'), fourcc, float(self.FPS),
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        path_to_json_dir = r"...\openpose_output\json"  # set backup path
