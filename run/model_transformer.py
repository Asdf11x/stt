...
class TransformerModel(nn.Module):
    ...
    def __init__(self, ntoken, ninp, nhead, nhid, nlayers, dropout=0.5):
        ...
        # uncomment to complete combined transformer
        # decoder_layer = nn.TransformerDecoderLayer(d_model=self.ninp, nhead=nhead).to(device)
    ...
    def forward(self, src, tgt):
        ...
        ## TRANSFORMER ENCODER
        # Use to reproduce results of written work
        # use "run with tgt mask" to use full transformer
        # "full transformer" is running, but takes much time to train and it not tweaked yet
